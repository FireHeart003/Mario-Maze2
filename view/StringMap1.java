...
public class StringMap1 extends JFrame{
	/*
	 * World 1 RESTART
	 * Same as String Map Class but this is the restart version
	...
	private int level = 0;
	private int cnt = 39;//number of steps player has
	...
	//Transitions player from World 1 to World 4(Transition scene)
	public void home() {
	...
	public void gamecheck1(Player _p, Maze _z, Minotaur _m, Rat _r1, Rat _r2, Rat _r3, Sword _sword, Teleport teleport, Question _q,
		...
		if(_p.getPosition().getRow() == _z.getEnd().getRow() && _p.getPosition().getCol() == _z.getEnd().getCol())
		{
			...
			level++;
			OverseerRestart.setLevelFalse1();
				levelDone();
		}
	...
	//Since player already restarted, no more option to restart so the game ends
	public void end() {
